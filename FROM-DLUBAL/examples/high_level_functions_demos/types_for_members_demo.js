...
memberStiffnessModification.SetModificationType("PARTIAL_STIFFNESSES_FACTORS");
memberStiffnessModification.SetMultiplierFactorsOfPartialStiffnesses(1.01, 1.02, 1.03, 1.04, 1.05, 1.06, 1.07);
var memberStiffnessModification2 = new MemberStiffnessModification(undefined, structure_modification);
memberStiffnessModification2.SetModificationType("TOTAL_STIFFNESSES_FACTORS");
memberStiffnessModification2.SetMultiplierFactorsOfTotalStiffnesses(1.01);
var memberStiffnessModification3 = new MemberStiffnessModification(undefined, structure_modification);
memberStiffnessModification3.SetModificationType("CONCRETE_STRUCTURES_ACI");
memberStiffnessModification3.SetConcreteStructure("BEAMS");
var memberStiffnessModification4 = new MemberStiffnessModification(undefined, structure_modification);
memberStiffnessModification4.SetModificationType("CONCRETE_STRUCTURES_CSA");
memberStiffnessModification4.SetConcreteStructure("BEAMS");
var memberStiffnessModification5 = new MemberStiffnessModification(undefined, structure_modification);
memberStiffnessModification5.SetModificationType("STEEL_STRUCTURES_360_16");
memberStiffnessModification5.SetSteelStructureAiscOrAisi("ITERATIVE", "ASD");
var memberStiffnessModification6 = new MemberStiffnessModification(undefined, structure_modification);
memberStiffnessModification6.SetModificationType("STEEL_STRUCTURES_360_10");
memberStiffnessModification6.SetSteelStructureAiscOrAisi("SET_TO_1");
var memberStiffnessModification7 = new MemberStiffnessModification(undefined, structure_modification);
memberStiffnessModification7.SetModificationType("STEEL_STRUCTURES_S100_16");
memberStiffnessModification7.SetSteelStructureAiscOrAisi("ITERATIVE", "ASD");
var memberStiffnessModification8 = new MemberStiffnessModification(undefined, structure_modification);
memberStiffnessModification8.SetModificationType("STEEL_STRUCTURES_CSA");
memberStiffnessModification8.SetSteelStructureCsa("SET_TO_1", 1.01, 1.02, 1.03, "APPLY_TAU_B", "APPLY_TAU_B", 1.04);
if (PRERELEASE_MODE) {
    var memberStiffnessModification9 = new MemberStiffnessModification(undefined, structure_modification);
    memberStiffnessModification9.SetModificationType("STEEL_STRUCTURES_GB");
    memberStiffnessModification9.SetSteelStructureGb(false, 1.11, 1.12);
}
...
memberShearPanel4.DefineSProv(10); // With object index specified

...
var MASUserDefined = new ModalAnalysisSettings().UserDefinedNumberOfModes(1, "UserDefinedNumberOfModes", 10, "METHOD_ROOT_OF_CHARACTERISTIC_POLYNOMIAL", "MASS_MATRIX_TYPE_CONSISTENT");
...
var MasMaxFrequency2 = new ModalAnalysisSettings().AutomaticNumberOfModesToReachEffMass(undefined, "AutomaticMaxNaturalFreq", 0.75, "METHOD_ROOT_OF_CHARACTERISTIC_POLYNOMIAL", "MASS_MATRIX_TYPE_UNIT");
MasMaxFrequency2.SetMassMatrixSettingsInDirection(false, false, false);
MasMaxFrequency2.SetMasMatrixSettingsAboutAxis(false, false, false);

...
ResultCombination.prototype.SRSSCombination = function (use_equivalent_linear_combination,
  ...
  //ASSERT(this.result_combination.generate_subcombinations === false, "If Generate sub-combinations of type 'Superposition' is set, SRSS combination is disabled");  // is disabled?

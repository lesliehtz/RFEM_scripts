...
/**
 * @returns Load combination number
 */
LoadCombination.prototype.GetNo = function () {
    return this.load_combination.no;
};

/**
 * @returns Load combination internal object
 */
LoadCombination.prototype.GetLoadCombination = function () {
    return this.load_combination;
};

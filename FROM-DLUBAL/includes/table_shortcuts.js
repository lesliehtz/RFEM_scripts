...
var UNIT = {
    ...
    // SUBCATEGORY_BUILDING_MODEL_BEAM_PANEL
    BEAM_PANEL_LENGTH: "BEAM_PANEL_LENGTH",
    BEAM_PANEL_THICKNESS: "BEAM_PANEL_THICKNESS",
    BEAM_PANEL_CONNECTOR_DIMENSION: "BEAM_PANEL_CONNECTOR_DIMENSION",
    BEAM_PANEL_CONNECTOR_SPACING: "BEAM_PANEL_CONNECTOR_SPACING",
...
function snow_load(no, name, multiplicity_counter_key) {
    return input_object("snow_load_" + no, SNOW_LOADS, name, multiplicity_counter_key);
}

function wind_load(no, name, multiplicity_counter_key) {
    return input_object("wind_load_" + no, WIND_LOADS, name, multiplicity_counter_key);
}

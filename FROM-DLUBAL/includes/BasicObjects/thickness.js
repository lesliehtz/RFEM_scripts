...
Thickness.prototype.StiffnessMatrix = function (no,
    ...
    rotation_beta = typeof rotation_beta !== 'undefined' ? rotation_beta : 0.0;
    consideration_of_self_weight = typeof consideration_of_self_weight !== 'undefined' ? consideration_of_self_weight : [];
    coefficient_of_thermal_expansion = typeof coefficient_of_thermal_expansion !== 'undefined' ? coefficient_of_thermal_expansion : 0;

    if (typeof stiffness_matrix === "undefined") {
        stiffness_matrix = [];
        stiffness_matrix.push(new Array());
        for (var i = 1; i <= 21; ++i) {
            stiffness_matrix[stiffness_matrix.length - 1].push(i * 100);
            if (i === 6 || i === 9 || i === 15 || i === 21) {
                stiffness_matrix.push(new Array());
            }
        }
    }

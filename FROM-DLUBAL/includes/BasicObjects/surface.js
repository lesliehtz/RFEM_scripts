 ...
 */
Surface.prototype.SetConcreteDesignProperties = function (enabled) {
	SetSurfaceConcreteDesignProperties(this.surface, enabled);
};
...
Surface.prototype.SetUserDefinedConcreteCover = function (concrete_cover_top,
	...
	SurfaceSetUserDefinedConcreteCover(this.surface, concrete_cover_top, concrete_cover_bottom, is_user_defined_concrete_cover_enabled);
};
...
/*Surface.prototype.SetConcreteCoverAccToEn1992 = function () {
	SurfaceSetConcreteCoverAccToEn1992(this.surface);
};*/	//Cannot be set (top surface side, bottom surface side)?
...
Surface.prototype.SetAssignments = function (surface_concrete_design_uls_configuration,
	...
	SurfaceSetAssignments(this.surface, surface_concrete_design_uls_configuration, surface_concrete_design_sls_configuration);
};
...
Surface.prototype.SetConcreteDesignReinforcementDirections = function (reinforcement_direction_top,
	...
	SurfaceSetConcreteDesignReinforcementDirections(this.surface, reinforcement_direction_top, reinforcement_direction_bottom);
};
...
Surface.prototype.SetConcreteDesignConcreteDurability = function (concrete_durability_top,
	...
	SurfaceSetConcreteDesignConcreteDurability(this.surface, concrete_durability_top, concrete_durability_bottom);
};
...
Surface.prototype.SetConcreteDesignSurfaceReinforcement = function (surface_reinforcement_nos) {
	SurfaceSetConcreteDesignSurfaceReinforcement(this.surface, surface_reinforcement_nos);
};
...
Surface.prototype.SetDeflectionAnalysis = function (deflection_check_surface_type,
	...
	SurfaceSetDeflectionAnalysis(this.surface, deflection_check_surface_type, deflection_check_displacement_reference, deflection_check_reference_length_z_definition_type, deflection_check_reference_length_z);
};
...
Surface.prototype.SetUserDefinedReferencePlane = function (reference_plane) {
	SurfaceSetUserDefinedReferencePlane(this.surface, reference_plane);
};

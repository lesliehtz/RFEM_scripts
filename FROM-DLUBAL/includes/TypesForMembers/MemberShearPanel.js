...
MemberShearPanel.prototype.Bracing = function (no,
    ...
    ASSERT(typeof material_name !== "undefined", "Material name must be specified");
    this.member_shear_panel.material_name = material_name;
...
MemberShearPanel.prototype.TrapezoidalSheetingAndBracing = function (no,
    ...
    comment,
    params) {
    this.TrapezoidalSheeting(no, member_supports_no, trapezoidal_sheeting_name, fastening_arrangement, comment, params);

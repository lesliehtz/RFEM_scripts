...
* @param	{String}	reference_to			Eccentricity is refereed to what ("NONE", "LEFT_TOP", "CENTER_TOP", "RIGHT_TOP", "LEFT_CENTER", "CENTER_CENTER", "RIGHT_CENTER", "LEFT_BOTTOM", "CENTER_BOTTOM", "RIGHT_BOTTOM", "CENTER_OF_GRAVITY", "SHEAR_CENTER")
...
MemberLoad.prototype.Eccentricity = function (reference_to,
	...
	if (reference_to !== "CENTER_OF_GRAVITY" && reference_to !== "SHEAR_CENTER" && reference_to !== "NONE") {
	...
	else if (reference_to === "CENTER_OF_GRAVITY" || reference_to === "NONE") {
		this.load.eccentricity_section_middle = GetMemberLoadEccentricityAlignment("ALIGN_MIDDLE_" + reference_to);
	}
...
function GetMemberLoadEccentricityAlignment(eccentricity_type) {
	...
	if (eccentricity_type !== "ALIGN_MIDDLE_CENTER_OF_GRAVITY" && eccentricity_type !== "ALIGN_MIDDLE_SHEAR_CENTER") {

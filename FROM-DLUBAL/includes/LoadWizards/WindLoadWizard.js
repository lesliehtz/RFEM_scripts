 ...
 * @param {Object}  params      Additional parameters, can be undefined
 */
function WindLoadWizard(no,
    comment,
    params) {
    if (arguments.length > 0) {
        this.memberWizard = createWindLoadWizard(no, comment, params);
    }
    return this.memberWizard;
}
...
function createWindLoadWizard (no,
    ...
    var windLoadWizard = engine.create_wind_load(no);

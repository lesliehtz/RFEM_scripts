...
MemberSupportNonlinearities.prototype.FailIfPositive = function () {
	this.support.nonlinearity_translational_z = member_supports.NONLINEARITY_FAILURE_IF_POSITIVE_CONTACT_STRESS_Z;
};

MemberSupportNonlinearities.prototype.FailIfNegative = function () {
	this.support.nonlinearity_translational_z = member_supports.NONLINEARITY_FAILURE_IF_NEGATIVE_CONTACT_STRESS_Z;
};

MemberSupportNonlinearities.prototype.None = function () {
	this.support.nonlinearity_translational_z = member_supports.NONLINEARITY_NONE;
};

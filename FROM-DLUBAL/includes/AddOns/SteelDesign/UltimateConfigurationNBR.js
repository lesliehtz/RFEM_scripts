 ...
 * @param {Number} property_reduction_factor_q          Total local buckling reduction factor for unclassifiable section, can be undefined (is not set, 1.0 as default)
 * @param {Number} property_reduction_factor_chi_sigma  Reduction factor for compressive strength acc. to 5.5.2.3(c), can be undefined (is not set, 1.0 as default)
 * @param {Number} property_reduction_factor_chi_tau    Reduction factor for shear strength acc. to 5.5.2.3(d), can be undefined (is not set, 1.0 as default)
...
SteelDesignUltimateConfigurationNBR.prototype.SetOptions = function (property_reduction_coefficient_c_t,
    property_reduction_factor_q,
    property_reduction_factor_chi_sigma,
    property_reduction_factor_chi_tau,
    ...
    if (typeof property_reduction_factor_q !== "undefined") {
        this.addon.settings_nbr.property_reduction_factor_q = property_reduction_factor_q;
    }
    if (typeof property_reduction_factor_chi_sigma !== "undefined") {
        this.addon.settings_nbr.property_reduction_factor_chi_sigma = property_reduction_factor_chi_sigma;
    }
    if (typeof property_reduction_factor_chi_tau !== "undefined") {
        this.addon.settings_nbr.property_reduction_factor_chi_tau = property_reduction_factor_chi_tau;
    }

 ...
 * @param {Boolean} property_use_elastic_design                         Uses elastic design according to 6.1.6 for the calculation of cold-formed sections, can be undefined (is not set, false as default)
 * @param {Boolean} property_consider_web_as_stiffened                  The web is considered as stiffened acc. to Tab. 6.1 (stiffening at the support, such as cleats, arranged to prevent distortion of the web and designed to resist the support reaction), can be undefined (is not set, false as default)
 * @param {Number} property_limiting_inclination_of_principal_axes      When the inclination of the principal axes calculated in the effective section is equal to or greater than the limiting inclination, LTB will not be checked acc. to 6.2.4(2), can be undefined
 */
SteelDesignUltimateConfigurationEC3.prototype.SetDesignOfColdFormedSection = function (property_design_of_cold_formed_sections_activate,
    ...
    property_use_elastic_design,
    property_consider_web_as_stiffened,
    property_limiting_inclination_of_principal_axes) {
    ...
    if (typeof property_use_elastic_design !== "undefined") {
        ASSERT(this.addon.settings_ec3.property_design_of_cold_formed_sections_activate, "Perform design of cold-formed sections must be activated");
        this.addon.settings_ec3.property_use_elastic_design = property_use_elastic_design;
    }
    if (typeof property_consider_web_as_stiffened != "undefined") {
        ASSERT(this.addon.settings_ec3.property_design_of_cold_formed_sections_activate, "Perform design of cold-formed sections must be activated");
        this.addon.settings_ec3.property_consider_web_as_stiffened = property_consider_web_as_stiffened;
    }
    if (typeof property_limiting_inclination_of_principal_axes !== "undefined") {
        ASSERT(this.addon.settings_ec3.property_design_of_cold_formed_sections_activate, "Perform design of cold-formed sections must be activated");
        this.addon.settings_ec3.property_limiting_inclination_of_principal_axes = property_limiting_inclination_of_principal_axes;
    }
};
...
/**
 * Sets Eccentric Loads on Members with I-Section
 * @param {Boolean} property_eccentric_loads_on_members_with_i_section_about_y          About y-axis, can be undefined (is not set, false as default)
 * @param {Number} property_eccentric_loads_on_members_with_i_section_eccentricity_z    Eccentricity value in local y-axis, can be undefined (is not set, 0 mm as default)
 * @param {Boolean} property_eccentric_loads_on_members_with_i_section_about_z          About z-axis, can be undefined (is not set, false as default)
 * @param {Number} property_eccentric_loads_on_members_with_i_section_eccentricity_y    Eccentricity value in local z-axis, can be undefined (is not set, 0 mm as default)
 */
SteelDesignUltimateConfigurationEC3.prototype.SetEccentricLoadsOnMembersWithISection = function (property_eccentric_loads_on_members_with_i_section_about_y,
    property_eccentric_loads_on_members_with_i_section_eccentricity_z,
    property_eccentric_loads_on_members_with_i_section_about_z,
    property_eccentric_loads_on_members_with_i_section_eccentricity_y) {
    if (typeof property_eccentric_loads_on_members_with_i_section_about_y !== "undefined") {
        this.addon.settings_ec3.property_eccentric_loads_on_members_with_i_section_about_y = property_eccentric_loads_on_members_with_i_section_about_y;
    }
    if (typeof property_eccentric_loads_on_members_with_i_section_eccentricity_z !== "undefined") {
        ASSERT(this.addon.settings_ec3.property_eccentric_loads_on_members_with_i_section_about_y, "About y-axis must be on");
        this.addon.settings_ec3.property_eccentric_loads_on_members_with_i_section_eccentricity_z = property_eccentric_loads_on_members_with_i_section_eccentricity_z;
    }
    if (typeof property_eccentric_loads_on_members_with_i_section_about_z !== "undefined") {
        this.addon.settings_ec3.property_eccentric_loads_on_members_with_i_section_about_z = property_eccentric_loads_on_members_with_i_section_about_z;
    }
    if (typeof property_eccentric_loads_on_members_with_i_section_eccentricity_y !== "undefined") {
        ASSERT(this.addon.settings_ec3.property_eccentric_loads_on_members_with_i_section_about_z, "About z-axis must be on");
        this.addon.settings_ec3.property_eccentric_loads_on_members_with_i_section_eccentricity_y = property_eccentric_loads_on_members_with_i_section_eccentricity_y;
    }
};

/**
 * Sets Analyze Stresses Caused by Mz Only with Substitute Half Section
 * @param {String} property_eccentric_transverse_loads_consider_mz_on       The bending moment Mz about the minor axis is applied only at the top or bottom chord with the substitute section (half of an I-section) (TOP_FLANGE, BOTTOM_FLANGE), can be undefined (is not set, TOP_FLANGE as default)
 */
SteelDesignUltimateConfigurationEC3.prototype.SetAnalyzeStressesCausedByMz = function (property_eccentric_transverse_loads_consider_mz_on) {
    this.addon.settings_ec3.property_eccentric_transverse_loads_consider_mz_on = EnumValueFromJSHLFTypeName(
        property_eccentric_transverse_loads_consider_mz_on,
        "eccentric transverse loads consider mz on",
        {
            "TOP_FLANGE": member_ulsconfig_steel_design_ec3.E_CONSIDER_MZ_ON_TOP_FLANGE,
            "BOTTOM_FLANGE": member_ulsconfig_steel_design_ec3.E_CONSIDER_MZ_ON_BOTTOM_FLANGE
        },
        member_ulsconfig_steel_design_ec3.E_CONSIDER_MZ_ON_TOP_FLANGE
    );
};

/**
 * Sets Design of Welds
 * @param {Boolean} property_welds_design_activate      Activate design of longitudinal welds, can be undefined (true as default)
 */
SteelDesignUltimateConfigurationEC3.prototype.SetDesignOfWelds = function (property_welds_design_activate) {
    if (typeof property_welds_design_activate === "undefined") {
        property_welds_design_activate = true;
    }
    this.addon.settings_ec3.property_welds_design_activate = property_welds_design_activate;
};

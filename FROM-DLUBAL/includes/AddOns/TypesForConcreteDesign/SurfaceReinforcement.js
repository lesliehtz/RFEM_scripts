/*
surface_reinforcement.rebar_diameter_auto_diameters (ACI, CSA) problem
*/
...
ConcreteDesignSurfaceReinforcement.prototype.SetRebarDiameter = function (rebar_diameter) {
    ...
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP") || IsConcreteDesignCurrentCodeOfStandard("NTC")) {
        ...
        this.surface_reinforcement.rebar_size = GetConcreteDesignBarNoForAciStandard(rebar_diameter);
    }
    else if (IsConcreteDesignCurrentCodeOfStandard("CSA")) {
        ASSERT(typeof rebar_diameter === "string", "Rebar diameter value must be a string");
        this.surface_reinforcement.rebar_size = GetConcreteDesignBarNoForCsaStandard(rebar_diameter);
    }
    else {
...
ConcreteDesignSurfaceReinforcement.prototype.SetRebarSpacing = function (rebar_spacing) {
    ...
    ASSERT(this.surface_reinforcement.reinforcement_type === surface_reinforcements.REINFORCEMENT_TYPE_REBAR, "Reinforcement type must be of rebar type");
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP") || IsConcreteDesignCurrentCodeOfStandard("NTC") ||
    IsConcreteDesignCurrentCodeOfStandard("ACI") || IsConcreteDesignCurrentCodeOfStandard("CSA")) {
...
ConcreteDesignSurfaceReinforcement.prototype.SetRebarDiameterAuto = function (rebar_diameter_auto_minimum,
    ...
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP") || IsConcreteDesignCurrentCodeOfStandard("NTC")) {
        ...
        if (typeof rebar_diameter_auto_minimum !== "undefined") {
            this.surface_reinforcement.rebar_size_auto_minimum = GetConcreteDesignBarNoForAciStandard(rebar_diameter_auto_minimum);
        }
        if (typeof rebar_diameter_auto_maximum !== "undefined") {
            this.surface_reinforcement.rebar_size_auto_maximum = GetConcreteDesignBarNoForAciStandard(rebar_diameter_auto_maximum);
        }
        if (typeof rebar_diameter_auto_diameters !== "undefined") {
            this.surface_reinforcement.rebar_diameter_auto_diameters_enabled = true;
            //this.surface_reinforcement.rebar_diameter_auto_diameters = rebar_diameter_auto_diameters;   // Can't set (??)
        }
    }
    else if (IsConcreteDesignCurrentCodeOfStandard("CSA"))
    {
        if (typeof rebar_diameter_auto_minimum !== "undefined") {
            this.surface_reinforcement.rebar_size_auto_minimum = GetConcreteDesignBarNoForCsaStandard(rebar_diameter_auto_minimum);
        }
        if (typeof rebar_diameter_auto_maximum !== "undefined") {
            this.surface_reinforcement.rebar_size_auto_maximum = GetConcreteDesignBarNoForCsaStandard(rebar_diameter_auto_maximum);
        }
        if (typeof rebar_diameter_auto_diameters !== "undefined") {
            this.surface_reinforcement.rebar_diameter_auto_diameters_enabled = true;
            //this.surface_reinforcement.rebar_diameter_auto_diameters = rebar_diameter_auto_diameters;   // Can't set (??)
...
ConcreteDesignSurfaceReinforcement.prototype.SetRebarSpacingAuto = function (rebar_spacing_auto_minimum,
    ...
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP") || IsConcreteDesignCurrentCodeOfStandard("ACI") || 
        IsConcreteDesignCurrentCodeOfStandard("CSA") || IsConcreteDesignCurrentCodeOfStandard("NTC")) {
...
ConcreteDesignSurfaceReinforcement.prototype.SetAdditionalRebarDiameter = function (value_1) {
    ...
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP") || IsConcreteDesignCurrentCodeOfStandard("NTC")) {
        ...
        this.surface_reinforcement.additional_rebar_size = GetConcreteDesignBarNoForAciStandard(value_1);
    }
    else if (IsConcreteDesignCurrentCodeOfStandard("CSA")) {
        this.surface_reinforcement.additional_rebar_size = GetConcreteDesignBarNoForCsaStandard(value_1);
    }
    else {
        ASSERT("Code of standard " + GetConcreteDesignCurrentCodeOfStandard() + " is not supported");
    }
 ...
 * @param {Number} additional_rebar_diameter_auto_minimum       Minimum diameter, can be undefined (is not set, 10 / #3 / 10M as default)
 * @param {Number} additional_rebar_diameter_auto_maximum       Maximum diameter, can be undefined (is not set, 20 / #6 / 20M as default)
 * @param {String} additional_rebar_diameter_auto_diameters     Diameters for reinforcement (e.g. '8.0, 10.0, 12.0, 14.0' / eg. '#1, #2, #3, #4, #5, #6', eg. '10M, 15M, 20M')
...
ConcreteDesignSurfaceReinforcement.prototype.SetAdditionalRebarDiameterAuto = function (additional_rebar_diameter_auto_minimum,
    ...
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP")) {
        if (typeof additional_rebar_diameter_auto_minimum !== "undefined") {
            ASSERT(typeof additional_rebar_diameter_auto_minimum === "number", "additional_rebar_diameter_auto_minimum must be number");
        ...
        if (typeof additional_rebar_diameter_auto_maximum !== "undefined") {
            ASSERT(typeof additional_rebar_diameter_auto_maximum === "number", "additional_rebar_diameter_auto_maximum must be number");
        ...
        if (typeof additional_rebar_diameter_auto_minimum !== "undefined") {
            ASSERT(typeof additional_rebar_diameter_auto_minimum === "string", "additional_rebar_diameter_auto_minimum must be string");
            this.surface_reinforcement.additional_rebar_size_auto_minimum = GetConcreteDesignBarNoForAciStandard(additional_rebar_diameter_auto_minimum);
        }
        if (typeof additional_rebar_diameter_auto_maximum !== "undefined") {
            ASSERT(typeof additional_rebar_diameter_auto_maximum === "string", "additional_rebar_diameter_auto_maximum must be string");
            this.surface_reinforcement.additional_rebar_size_auto_maximum = GetConcreteDesignBarNoForAciStandard(additional_rebar_diameter_auto_maximum);
        }
        if (typeof additional_rebar_diameter_auto_diameters !== "undefined") {
            this.surface_reinforcement.additional_rebar_diameter_auto_diameters_enabled = true;
            //this.surface_reinforcement.additional_rebar_diameter_auto_diameters = additional_rebar_diameter_auto_diameters;   // Can't set (??)
        }
    }
    else if (IsConcreteDesignCurrentCodeOfStandard("CSA")) {
        if (typeof additional_rebar_diameter_auto_minimum !== "undefined") {
            ASSERT(typeof additional_rebar_diameter_auto_minimum === "string", "additional_rebar_diameter_auto_minimum must be string");
            this.surface_reinforcement.additional_rebar_size_auto_minimum = GetConcreteDesignBarNoForCsaStandard(additional_rebar_diameter_auto_minimum);
        }
        if (typeof additional_rebar_diameter_auto_maximum !== "undefined") {
            ASSERT(typeof additional_rebar_diameter_auto_maximum === "string", "additional_rebar_diameter_auto_maximum must be string");
            this.surface_reinforcement.additional_rebar_size_auto_maximum = GetConcreteDesignBarNoForCsaStandard(additional_rebar_diameter_auto_maximum);
        }
        if (typeof additional_rebar_diameter_auto_diameters !== "undefined") {
            this.surface_reinforcement.additional_rebar_diameter_auto_diameters_enabled = true;
            //this.surface_reinforcement.additional_rebar_diameter_auto_diameters = additional_rebar_diameter_auto_diameters;   // Can't set (??)
...
ConcreteDesignSurfaceReinforcement.prototype.SetStirrupsDiameter = function (diameter) {
    ...
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP")) {
        ...
        this.surface_reinforcement.stirrup_size = GetConcreteDesignBarNoForAciStandard(diameter);
    }
    else if (IsConcreteDesignCurrentCodeOfStandard("CSA")) {
        this.surface_reinforcement.stirrup_size = GetConcreteDesignBarNoForCsaStandard(diameter);
    }
    else {
        ASSERT("Code of standard " + GetConcreteDesignCurrentCodeOfStandard() + " is not supported");
    }
...
ConcreteDesignSurfaceReinforcement.prototype.SetStirrupsDiameterAuto = function (stirrup_diameter_auto_minimum,
    ...
    if (IsConcreteDesignCurrentCodeOfStandard("EN") || IsConcreteDesignCurrentCodeOfStandard("SP") || IsConcreteDesignCurrentCodeOfStandard("NTC")) {
        ...
        if (typeof stirrup_diameter_auto_minimum !== "undefined") {
            this.surface_reinforcement.stirrup_size_auto_minimum = GetConcreteDesignBarNoForAciStandard(stirrup_diameter_auto_minimum);
        }
        if (typeof stirrup_diameter_auto_maximum !== "undefined") {
            this.surface_reinforcement.stirrup_size_auto_maximum = GetConcreteDesignBarNoForAciStandard(stirrup_diameter_auto_maximum);
        }
        if (typeof stirrup_diameter_auto_diameters !== "undefined") {
            this.surface_reinforcement.stirrup_diameter_auto_diameters_enabled = true;
            //this.surface_reinforcement.stirrup_diameter_auto_diameters = stirrup_diameter_auto_diameters;
        ...
        if (typeof stirrup_diameter_auto_minimum !== "undefined") {
            this.surface_reinforcement.stirrup_size_auto_minimum = GetConcreteDesignBarNoForCsaStandard(stirrup_diameter_auto_minimum);
        }
        if (typeof stirrup_diameter_auto_maximum !== "undefined") {
            this.surface_reinforcement.stirrup_size_auto_maximum = GetConcreteDesignBarNoForCsaStandard(stirrup_diameter_auto_maximum);
        }
        if (typeof stirrup_diameter_auto_diameters !== "undefined") {
            this.surface_reinforcement.stirrup_diameter_auto_diameters_enabled = true;
            //this.surface_reinforcement.stirrup_diameter_auto_diameters = stirrup_diameter_auto_diameters;
        ...
        ASSERT(false, "Unknown code of standard: " + GetConcreteDesignCurrentCodeOfStandard());
    }
...
function GetConcreteDesignBarNoForCsaStandard (rebar_size_calculated) {
    return EnumValueFromJSHLFTypeName(
        rebar_size_calculated,
        "rebar size calculated",
        {

 ...
 */
StructureModification.prototype.GetStructureModification = function () {
	return this.structure_modification;
};

/**
 * 
 * @returns Structure modification number
 */
StructureModification.prototype.GetNo = function () {
	return this.structure_modification.no;
};
